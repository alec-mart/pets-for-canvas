...
_Effective 2026-09-10. This policy is written to be read, not skimmed. It is short because we collect very little._
...
Uninstalling the extension deletes everything stored in your browser. To delete your rewards from our server, email the address below with the device id shown in the extension's Settings section. We delete the device and everything stored under it.
