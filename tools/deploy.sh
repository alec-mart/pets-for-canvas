...
# can be checked against the public repository. Run from a clean, pushed checkout, or pass the
# public commit as the first argument when deploying from elsewhere.
set -e
cd "$(dirname "$0")/.."
