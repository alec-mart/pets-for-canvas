...
// GET a Canvas API path as JSON (missing_submissions and planner items for streak/overdue state; the current assignment's own submission record; courses for visits)
