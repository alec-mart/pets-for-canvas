// Collar styling engine, shared by pet.js, the popup and the bench. Given a mounted rig <svg>
// and a collar def, recolors/patterns the .cd-collar band and tag and attaches the effect.
const COLLAR_DEFS = [
  ...
  // legendary
  { id: "scroll", name: "Scroll", rarity: "rare", fill: "#15120F", pattern: { kind: "scroll", base: "#15120F", ink: "#F0C24A", width: 48 }, tag: "#15120F", tagRim: "#F0C24A", launch: true }, // launch collar: redeem code only, never in the box
...
// ambient particles for the top tiers; one system, two hosts (page and popup).
// coin (gold), spark (ember), snow (frost), trail (comet while moving). Returns stop().
const COLLAR_MOTES = {
